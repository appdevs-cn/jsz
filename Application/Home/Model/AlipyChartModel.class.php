...
class AlipyChartModel
{
    ...
    static function getInstance($money=0)
    {
        ...
        {
            self::$_instance = new WeChartModel($money);
        }
    ...
    public function showOrder()
    {
        ...
        $onlinetool_rows=M('detail_onlinetool')->where(array("toolid"=>9,"status"=>1))->find();
        ...
        if($resp_code=="SUCCESS"){
            ...
            if(file_exists('/home/www/www.jsz.com/Jsz/Resourse/Home/images/qrcode.png')){							
                unlink('/home/www/www.jsz.com/Jsz/Resourse/Home/images/qrcode.png');
            }
            $pic="/home/www/www.jsz.com/Jsz/Resourse/Home/images/qrcode.png";
            $errorCorrectionLevel = 'L';
            $matrixPointSize = 10;
            \QRcode::png ( $qrcode, $pic, $errorCorrectionLevel, $matrixPointSize, 2 );
            return "/Resourse/Home/images/qrcode.png";
        }
    }
}
