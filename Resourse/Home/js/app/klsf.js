window.LOTTERYCONF = {
        "klsf": {
            ...
            games: {
                "dwd": {
                    describe: {
                        title: "游戏玩法：从八个位数中，任意选择一个或一个以上的号码投注。",
                        content: "投注方案：1<br />从八个位数中，任意选择一个或一个以上的号码投注，选号与开奖号码对应位置一致即为中奖"
                    },
                    items: [{
                        title: "第一位",
                        tools: [{
                ...
                "rx1": {
                    describe: {
                        title: "游戏玩法：至少选择1个号码投注。",
                        content: "投注方案：1<br /> 至少选择1个号码投注，选号与开奖号码任意1位一致即中奖"
                    },
                    items: [{
                        title: "任选一",
                        tools: [{
                ...
                "rx2": {
                    describe: {
                        title: "游戏玩法：至少选择2个号码投注。",
                        content: "投注方案：1 2<br /> 至少选择1个号码投注，选号与开奖号码任意2位一致即中奖"
                    },
                    items: [{
                        title: "任选二",
                        tools: [{
                ...
                "rx3": {
                    describe: {
                        title: "游戏玩法：至少选择3个号码投注。",
                        content: "投注方案：1 2 3<br /> 至少选择1个号码投注，选号与开奖号码任意3位一致即中奖"
                    },
                    items: [{
                        title: "任选三",
                        tools: [{
                ...
                "rx4": {
                    describe: {
                        title: "游戏玩法：至少选择4个号码投注。",
                        content: "投注方案：1 2 3 4<br /> 至少选择1个号码投注，选号与开奖号码任意4位一致即中奖"
                    },
                    items: [{
                        title: "任选四",
                        tools: [{
                ...
                "rx5": {
                    describe: {
                        title: "游戏玩法：至少选择5个号码投注。",
                        content: "投注方案：1 2 3 4 5<br /> 至少选择1个号码投注，选号与开奖号码任意5位一致即中奖"
                    },
                    items: [{
                        title: "任选五",
                        tools: [{
                ...
                "rx2dt": {
                    describe: {
                        title: "游戏玩法：胆码可选1，拖码可选2-10个，拖码个数加胆码个数要大于2。",
                        content: "投注方案：胆15拖9<br /> 胆码可选1，拖码可选2-10个，拖码个数加胆码个数要大于2，选号与开奖号码一致即中奖"
                    },
                    items: [{
                        title: "胆号",
                        tools: [{
                ...
                "rx3dt": {
                    describe: {
                        title: "游戏玩法： 胆码可选1-2，拖码可选2-10个，拖码个数加胆码个数要大于3。",
                        content: "投注方案：胆15拖9 10<br /> 胆码可选1-2，拖码可选2-10个，拖码个数加胆码个数要大于3，选号与开奖号码一致即中奖"
                    },
                    items: [{
                        title: "胆号",
                        tools: [{
                ...
                "rx4dt": {
                    describe: {
                        title: "游戏玩法： 胆码可选1-3，拖码可选2-10个，拖码个数加胆码个数要大于4。",
                        content: "投注方案：胆15拖9 3 2 7<br /> 胆码可选1-3，拖码可选2-10个，拖码个数加胆码个数要大于4，选号与开奖号码一致即中奖"
                    },
                    items: [{
                        title: "胆号",
                        tools: [{
                ...
                "rx5dt": {
                    describe: {
                        title: "游戏玩法： 胆码可选1-4，拖码可选2-10个，拖码个数加胆码个数要大于5。",
                        content: "投注方案：胆15拖9 3 2 7 1<br /> 胆码可选1-4，拖码可选2-10个，拖码个数加胆码个数要大于5，选号与开奖号码一致即中奖"
                    },
                    items: [{
                        title: "胆号",
                        tools: [{
                ...
                "2l": {
                    describe: {
                        title: "游戏玩法：从第一位、第二位各选一个号码组成一注。",
                        content: "投注方案：3 2 ******<br /> 投注的2个号码与开奖的8个号码中任2个连续号码相同且顺序一致即中奖"
                    },
                    items: [{
                        title: "第一位",
                        tools: [{
                ...
                "2lz": {
                    describe: {
                        title: "游戏玩法：从1--20中任意选择或两个以上的号码组成一注。",
                        content: "投注方案：9 15<br /> 投注的2个号码与开奖的8个号码中任2个连续号码相同（顺序不限）即中奖"
                    },
                    items: [{
                        title: "二连组",
                        tools: [{
                ...
                "q3fs": {
                    describe: {
                        title: "游戏玩法：3位各选1个或多个号码投注，选号与开奖号码前3位按位一致即中奖。",
                        content: "投注方案：15 9 3<br /> 前3位各选1个或多个号码投注，选号与开奖号码前3位按位一致即中奖,选号与开奖号码一致即中奖"
                    },
                    items: [{
                        title: "第一位",
                        tools: [{
                ...
                "q3zxfs": {
                    describe: {
                        title: "游戏玩法：至少选择3个号码投注，选号包含开奖号码前3位即中奖。",
                        content: "投注方案：15 3 9<br /> 至少选择3个号码投注，选号包含开奖号码前3位（顺序不限）即中奖"
                    },
                    items: [{
                        title: "组选",
                        tools: [{
                ...
                "h3fs": {
                    describe: {
                        title: "游戏玩法：3位各选1个或多个号码投注，选号与开奖号码后3位按位一致即中奖。",
                        content: "投注方案：15 9 3<br /> 前3位各选1个或多个号码投注，选号与开奖号码后3位按位一致即中奖,选号与开奖号码一致即中奖"
                    },
                    items: [{
                        title: "第六位",
                        tools: [{
                ...
                "h3zxfs": {
                    describe: {
                        title: "游戏玩法：至少选择3个号码投注，选号包含开奖号码后3位即中奖。",
                        content: "投注方案：15 3 9<br /> 至少选择3个号码投注，选号包含开奖号码后3位（顺序不限）即中奖"
                    },
                    items: [{
                        title: "组选",
                        tools: [{
    ...
    var ssc = {
        ...
        ,Loading: function()
        {
            ...
            imagesLoaded('.JszContent',function(){
                ...
                }),games.html(tpl("#tabs_tpl", r)).find("a:eq(1)").trigger("click")
                ...
                window.rx2dt = function()
                {
                    ...
                    if(parseFloat($count1)>($u-1) || parseFloat($count1)<1)
                    {
                        alertify.error("<div class='text'><i class='ico-error'></i>胆码个数只能选择1个胆码2-10个拖码<i class='err-close'></i></div>")
                        $("#J__selNums li:eq(0)").find(".lottery-ball").removeClass('on')
                    }
                    if(add <= $u || parseFloat($count1) >($u-1) || $count2<2) return 0
                ...
                window.rx3dt = function()
                {
                    ...
                    if(parseFloat($count1)>($u-1) || parseFloat($count1)<1)
                    {
                        alertify.error("<div class='text'><i class='ico-error'></i>胆码个数只能选择1-"+($u-1)+"个胆码2-10个拖码<i class='err-close'></i></div>")
                        $("#J__selNums li:eq(0)").find(".lottery-ball").removeClass('on')
                    }
                    if(add <= $u || parseFloat($count1) >($u-1) || $count2<2) return 0
                    for (var i=$count2; i>0; i--) {
                ...
                /*todo 2连组*/
                window.m2lz = function()
                {
                    $select = window.select
                    $count = $select[0]
                    if($count<2) return 0
                    var chushu = 1, beichushu = 1, sheshu = 1;
                    ...
                    return parseFloat(chushu)/(parseFloat(beichushu)*parseFloat(sheshu))
                }
        ...
        ,socketEvent: function()
        {
            ...
            {
                case 10:
                    $event = "cqklsfOpenCode";break;
                case 9:
                    $event = "gdklsfOpenCode";break;
                case 26:
                    $event = "sxklsfOpenCode";break;
                case 27:
                    $event = "sxxklsfOpenCode";break;
            }
