...
!(function(win){
    var indexHandler = {
        ...
        ,getTeamReport: function()
        {
            ...
            $.post("/getTeamReport",$data,function(data){
                ...
                $("a[data-method=searchChild]").on("click",function(){
                    $('input[name=username]').val($(this).attr('uname'));
                    indexHandler.getTeamReport();
                })
                $("a[data-method=slefreport]").on("click",function(){
                    _html = $(this).attr("data-content")
                    $.dialog.open({
                        title: '自身盈亏',
                        width: 300,
                        height:435,
                        ...
                        o.html(tpl('#sleft_report',{rows:_html}))
                    })
                })
